...
class MeasurementsApiTest < ActionDispatch::IntegrationTest
  ...
  test 'get api/measurements' do
    ...
    expected_response = [
        {"datetime"=>"2017-11-09T23:00:00.000Z", "value"=>3.0, "measurementType"=>"Discharge", "stationId"=>745744336, "unit"=>"m3/s", "warnLevel"=>1},
        ...
        {"datetime"=>"2017-11-09T23:00:00.000Z", "value"=>12.0, "measurementType"=>"DischargeLiter", "stationId"=>745744336, "unit"=>"l/s", "warnLevel"=>0},
        {"measurementType"=>"Weather", "airTemp"=>16.0, "windSpeed"=>15.8, "indicator"=>"cloud", "datetime"=>"2017-09-06T12:00:00.000Z"}
    ]
